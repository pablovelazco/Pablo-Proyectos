...
check_login();
$id = intval($_GET['id']); // Obtener el valor del ID
...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['msg'] = "¡Especialización del doctor actualizada con éxito!";
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <!-- Enlaces a los estilos (ya proporcionados en el código original) -->
                    ...
                    <section id="page-title">
                        <div class="row">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>Editar Especialización del Doctor</span></li>
                            </ol>
                        </div>
                    </section>
                                            ...
                                            <div class="panel-body">
                                                <form role="form" name="dcotorspcl" method="post">
                                                    <div class="form-group">
                                                        <label for="doctorspecilization">Editar Especialización del Doctor</label>
                                                        <?php
                                                        $id = intval($_GET['id']);
